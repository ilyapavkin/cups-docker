...
HPLIP_VERSION="${HPLIP_VERSION:-3.18.12}" # libsane-hpaio version 3.18.12 in current buster repo
...
apt-get install -qy -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" libsane-hpaio
